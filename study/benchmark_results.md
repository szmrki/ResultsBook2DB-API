...
最終更新: 2026-08-09 / 状態: **Q1〜Q4 完了**（経路3・4 は未測定）
...
**「PostgreSQL は 157万行程度なら十分速い」という仮説が、Q1〜Q4 で一貫して裏付けられた。**
...
| | Q1 | Q2 | Q3 | Q4 |
|---|---:|---:|---:|---:|
| PostgreSQL | 0.024 | 0.038 | 0.139 | 0.026 |
| Spark（最速の分割数） | 0.188 | 0.191 | 0.598 | 0.153 |
| PG が速い倍率 | 7.8× | 5.0× | 4.3× | 5.9× |

クエリが重くなるほど差は縮まる（Q1 7.8× → Q3 4.3×）が、**逆転はしていない**。
